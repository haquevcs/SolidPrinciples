...
namespace ISP
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Secondly, instead of creating a large or you can say fat interfaces, create multiple smaller interfaces with the aim that
            the clients should only think about the methods that are of interest to them.
